...
pronghorn.l <- animal.l %>% filter(spp == "pronghorn")
...
# 
# saveRDS (mcmc_lo, "./result/mcmc_syndrome_prong_loc.RDS")
# 
...
#                      data = as.data.frame(pronghorn.l))
# 
# saveRDS (mcmc_me, "./result/mcmc_syndrome_prong_mec.RDS")
# 
...
#                      data = as.data.frame(pronghorn.l))
# 
# saveRDS (mcmc_hi, "./result/mcmc_syndrome_prong_hic.RDS")
# 
...
#                      data = as.data.frame(pronghorn.l))
# 
# saveRDS (mcmc_exhi, "./result/mcmc_syndrome_prong_ehc.RDS")
# 
...
mcmc_lo <- readRDS("./result/mcmc_syndrome_prong_loc.RDS")
mcmc_me <- readRDS("./result/mcmc_syndrome_prong_mec.RDS")
mcmc_hi <- readRDS("./result/mcmc_syndrome_prong_hic.RDS")
mcmc_exhi <- readRDS("./result/mcmc_syndrome_prong_ehc.RDS")
