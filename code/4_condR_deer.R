...
# calculation of these fence density quantiles see condR_prong
lo = 0.39
me = 0.68
hi = 1.00
exhi = 1.49
...
#                        verbose = TRUE,
#                        data = deer.l)
# saveRDS(mcmc_PC1_mc, "result/mcmc_deer_pc1_condR_mc.RDS")
# 
...
#                           verbose = TRUE,
#                           data = deer.l)
# saveRDS(mcmc_PC2_mc, "result/mcmc_deer_pc2_condR_mc.RDS")
# 
# #################### lo centered###########
...
#                         verbose = TRUE,
#                         data = deer.l)
# saveRDS(mcmc_PC1_lc, "result/mcmc_deer_pc1_condR_lc.RDS")
# 
...
#                         verbose = TRUE,
#                         data = deer.l)
# saveRDS(mcmc_PC2_lc, "result/mcmc_deer_pc2_condR_lc.RDS")
# 
# 
# #################### hi centered ###########
...
#                         verbose = TRUE,
#                         data = deer.l)
# saveRDS(mcmc_PC1_hc, "result/mcmc_deer_pc1_condR_hc.RDS")
# 
...
#                         verbose = TRUE,
#                         data = deer.l)
# saveRDS(mcmc_PC2_hc, "result/mcmc_deer_pc2_condR_hc.RDS")
# 
# #################### extra hi centered ###########
...
#                         verbose = TRUE,
#                         data = deer.l)
# saveRDS(mcmc_PC1_ehc, "result/mcmc_deer_pc1_condR_ehc.RDS")
# 
...
#                         verbose = TRUE,
#                         data = deer.l)
# saveRDS(mcmc_PC2_ehc, "result/mcmc_deer_pc2_condR_ehc.RDS")

# #################################################################
# ############################ condR  #############################
# #################################################################
mcmc_PC1_lc <- readRDS("result/mcmc_deer_pc1_condR_lc.RDS")
mcmc_PC1_mc <- readRDS("result/mcmc_deer_pc1_condR_mc.RDS")
mcmc_PC1_hc <- readRDS("result/mcmc_deer_pc1_condR_hc.RDS")
mcmc_PC1_ehc <- readRDS("result/mcmc_deer_pc1_condR_ehc.RDS")

mcmc_PC2_lc <- readRDS("result/mcmc_deer_pc2_condR_lc.RDS")
mcmc_PC2_mc <- readRDS("result/mcmc_deer_pc2_condR_mc.RDS")
mcmc_PC2_hc <- readRDS("result/mcmc_deer_pc2_condR_hc.RDS")
mcmc_PC2_ehc <- readRDS("result/mcmc_deer_pc2_condR_ehc.RDS")

PC1_r_lc <- mcmc_PC1_lc$VCV[,"(Intercept):(Intercept).id"]/
  (mcmc_PC1_lc$VCV[,"(Intercept):(Intercept).id"] + mcmc_PC1_lc$VCV[,"units"] )
mean(PC1_r_lc) #。09966418
