...
#                       data = deer.l)
# # plot(mcmc_PC1_1)
# saveRDS(mcmc_PC1_1, "result/models/mcmc_deer_pc1_randint.RDS")
# 
...
#                        data = deer.l)
# # plot(mcmc_PC2_1)
# saveRDS(mcmc_PC2_1, "result/models/mcmc_deer_pc2_randint.RDS")
# 
...
#                     saveZ = TRUE)
# # plot(mcmc_PC1_2)
# saveRDS(mcmc_PC1_2, "result/models/mcmc_deer_pc1_randreg.RDS")
# 
...
#                        saveZ = TRUE)
# # plot(mcmc_PC2_2)
# saveRDS(mcmc_PC2_2, "result/models/mcmc_deer_pc2_randreg.RDS")
